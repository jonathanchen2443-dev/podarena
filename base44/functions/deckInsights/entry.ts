  ...
  try {
    ...
    return Response.json({
      ...
      deck: {
        ...
        deck_list_import_status: deck.deck_list_import_status || 'not_imported',
        deck_list_last_synced_at: deck.deck_list_last_synced_at || null,
        deck_list_source_host: deck.deck_list_source_host || null,
        deck_list_card_count: deck.deck_list_card_count || null,
