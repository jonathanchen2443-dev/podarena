...
const SHELL_SUB_PAGES = ["dashboard", "approvals", "decks", "profiledecks", "userprofile", "founder", "editpod", "praises", "randomdeckpicker", "deckinsights", "gamesummary", "gameapproval"];
