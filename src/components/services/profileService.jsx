...
export async function searchProfiles(query, limit = 20) {
  ...
  // Fetch a reasonable pool — filtered client-side since entity filter doesn't support LIKE
 ...
 * Returns { gamesPlayed, wins, decksCount }
 * Cached per userId with a 60s TTL and in-flight dedup.
 */
