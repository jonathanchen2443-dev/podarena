            ...
            >
              <CardContent className="p-4 flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl flex items-center justify-center flex-shrink-0 ds-accent-bg ds-accent-bd border">
                    <Users className="w-5 h-5" style={{ color: "var(--ds-primary-text)" }} />
                  </div>
